...
const resources = {
  en: {
    translation: {
      ...
      vault_hero_body: 'Move funds into a vault that can only be opened with your YubiKey. Deposits are instant; withdrawals need the key, your PIN, and a touch.',
      ...
      vault_deposit_sub: 'Move funds from your everyday balance into the vault. No key needed.',
      ...
      vault_enroll_intro: 'Your YubiKey will guard a private key that locks the vault. Have it ready to insert.',
      ...
      vault_enroll_phase_sealing: 'Sealing the vault…',
      ...
      vault_err_seal_corrupt: 'The vault seal could not be opened.',
      ...
      vault_recover_sub: 'Lost or broken YubiKey? Enter your 24-word backup phrase to move all vault funds to your everyday balance and clear the vault.',
  ...
  zh: {
    translation: {
      ...
      vault_deposit_sub: '将资金从日常余额转入保险库。无需密钥。',
      ...
      vault_enroll_phase_sealing: '正在封存保险库…',
      ...
      vault_continue: '继续',
      vault_backup_title: '您的恢复助记词',
      vault_backup_warning: '请将这 24 个词抄写下来并离线保存。如果您同时丢失 YubiKey 和这组助记词，保险库中的资金将永远无法找回。',
      vault_backup_saved: '我已抄写下来',
      vault_backup_confirm_title: '确认您的助记词',
      vault_backup_confirm_sub: '输入所要求的词以确认您已保存。',
      vault_backup_quiz_wrong: '不匹配。请核对您抄写的助记词。',
      vault_word_n: '第 {{n}} 个词',
      vault_finish: '完成',
      ...
      vault_err_seal_corrupt: '无法打开保险库封印。',
  ...
  hi: {
    translation: {
      ...
      vault_hero_body: 'धन को एक ऐसे वॉल्ट में ले जाएँ जिसे केवल आपकी YubiKey से ही खोला जा सकता है। जमा तुरंत होता है; निकासी के लिए कुंजी, आपका PIN और एक स्पर्श चाहिए।',
      ...
      vault_balance_label: 'वॉल्ट बैलेंस',
      ...
      vault_deposit_sub: 'अपने रोज़मर्रा के बैलेंस से धन वॉल्ट में ले जाएँ। कुंजी की ज़रूरत नहीं।',
      ...
      vault_enroll_phase_sealing: 'वॉल्ट सील किया जा रहा है…',
      ...
      vault_backup_title: 'आपका रिकवरी वाक्यांश',
      vault_backup_warning: 'इन 24 शब्दों को लिखकर ऑफ़लाइन सुरक्षित रखें। यदि आप अपनी YubiKey और यह वाक्यांश दोनों खो देते हैं, तो वॉल्ट का धन हमेशा के लिए चला जाएगा।',
      vault_backup_saved: 'मैंने इसे लिख लिया है',
      vault_backup_confirm_title: 'अपना वाक्यांश पुष्टि करें',
      vault_backup_confirm_sub: 'पुष्टि के लिए अनुरोधित शब्द दर्ज करें कि आपने उन्हें सहेज लिया है।',
      vault_backup_quiz_wrong: 'यह मेल नहीं खाता। अपना लिखा हुआ वाक्यांश जाँचें।',
      vault_word_n: 'शब्द {{n}}',
      vault_finish: 'समाप्त',
      ...
      vault_err_seal_corrupt: 'वॉल्ट की सील नहीं खोली जा सकी।',
  ...
  es: {
    translation: {
      ...
      vault_hero_body: 'Mueve fondos a una caja fuerte que solo se puede abrir con tu YubiKey. Los depósitos son instantáneos; las retiradas necesitan la llave, tu PIN y un toque.',
      ...
      vault_balance_label: 'Saldo de la caja fuerte',
      ...
      vault_deposit_sub: 'Mueve fondos de tu saldo diario a la caja fuerte. No hace falta la llave.',
      ...
      vault_enroll_phase_sealing: 'Sellando la caja fuerte…',
      ...
      vault_backup_title: 'Tu frase de recuperación',
      vault_backup_warning: 'Anota estas 24 palabras y guárdalas sin conexión. Si pierdes tu YubiKey Y esta frase, los fondos de la caja fuerte se perderán para siempre.',
      vault_backup_saved: 'Ya la he anotado',
      vault_backup_confirm_title: 'Confirma tu frase',
      vault_backup_confirm_sub: 'Introduce las palabras solicitadas para confirmar que las guardaste.',
      vault_backup_quiz_wrong: 'No coincide. Revisa tu frase anotada.',
      vault_word_n: 'Palabra {{n}}',
      vault_finish: 'Finalizar',
      ...
      vault_err_seal_corrupt: 'No se pudo abrir el sello de la caja fuerte.',
  ...
  fr: {
    translation: {
      ...
      vault_hero_body: 'Placez des fonds dans un coffre qui ne peut être ouvert qu\'avec votre YubiKey. Les dépôts sont instantanés ; les retraits nécessitent la clé, votre PIN et un contact.',
      ...
      vault_balance_label: 'Solde du coffre',
      ...
      vault_deposit_sub: 'Transférez des fonds de votre solde courant vers le coffre. Aucune clé requise.',
      ...
      vault_enroll_phase_sealing: 'Scellage du coffre…',
      ...
      vault_backup_title: 'Votre phrase de récupération',
      vault_backup_warning: 'Notez ces 24 mots et conservez-les hors ligne. Si vous perdez votre YubiKey ET cette phrase, les fonds du coffre seront perdus à jamais.',
      vault_backup_saved: 'Je l\'ai notée',
      vault_backup_confirm_title: 'Confirmez votre phrase',
      vault_backup_confirm_sub: 'Saisissez les mots demandés pour confirmer que vous les avez enregistrés.',
      vault_backup_quiz_wrong: 'Cela ne correspond pas. Vérifiez votre phrase notée.',
      vault_word_n: 'Mot {{n}}',
      vault_finish: 'Terminer',
      ...
      vault_err_seal_corrupt: 'Le sceau du coffre n\'a pas pu être ouvert.',
  ...
  ar: {
    translation: {
      ...
      vault_hero_body: 'انقل الأموال إلى خزنة لا يمكن فتحها إلا بمفتاح YubiKey الخاص بك. الإيداعات فورية؛ وتتطلب عمليات السحب المفتاح ورمز PIN ولمسة.',
      ...
      vault_balance_label: 'رصيد الخزنة',
      ...
      vault_deposit_sub: 'انقل الأموال من رصيدك اليومي إلى الخزنة. لا حاجة إلى المفتاح.',
      ...
      vault_enroll_phase_sealing: 'جارٍ ختم الخزنة…',
      ...
      vault_backup_title: 'عبارة الاسترداد الخاصة بك',
      vault_backup_warning: 'اكتب هذه الكلمات الـ 24 واحتفظ بها دون اتصال. إذا فقدت مفتاح YubiKey وهذه العبارة معًا، فستضيع أموال الخزنة إلى الأبد.',
      vault_backup_saved: 'لقد كتبتها',
      vault_backup_confirm_title: 'تأكيد عبارتك',
      vault_backup_confirm_sub: 'أدخل الكلمات المطلوبة لتأكيد أنك حفظتها.',
      vault_backup_quiz_wrong: 'غير مطابق. تحقق من العبارة التي كتبتها.',
      vault_word_n: 'الكلمة {{n}}',
      vault_finish: 'إنهاء',
      ...
      vault_err_seal_corrupt: 'تعذّر فتح ختم الخزنة.',
  ...
  pt: {
    translation: {
      ...
      vault_hero_body: 'Mova fundos para um cofre que só pode ser aberto com a sua YubiKey. Os depósitos são instantâneos; as retiradas exigem a chave, o seu PIN e um toque.',
      ...
      vault_balance_label: 'Saldo do cofre',
      ...
      vault_deposit_sub: 'Mova fundos do seu saldo do dia a dia para o cofre. Nenhuma chave necessária.',
      ...
      vault_enroll_phase_sealing: 'Selando o cofre…',
      ...
      vault_continue: 'Continuar',
      vault_backup_title: 'A sua frase de recuperação',
      vault_backup_warning: 'Anote estas 24 palavras e guarde-as offline. Se você perder a sua YubiKey E esta frase, os fundos do cofre serão perdidos para sempre.',
      vault_backup_saved: 'Já anotei',
      vault_backup_confirm_title: 'Confirme a sua frase',
      vault_backup_confirm_sub: 'Digite as palavras solicitadas para confirmar que você as guardou.',
      vault_backup_quiz_wrong: 'Não corresponde. Verifique a sua frase anotada.',
      vault_word_n: 'Palavra {{n}}',
      vault_finish: 'Concluir',
      ...
      vault_err_seal_corrupt: 'Não foi possível abrir o selo do cofre.',
  ...
  bn: {
    translation: {
      ...
      vault_hero_body: 'তহবিল এমন একটি ভল্টে সরান যা কেবল আপনার YubiKey দিয়ে খোলা যায়। জমা তাৎক্ষণিক; উত্তোলনের জন্য কী, আপনার PIN এবং একটি স্পর্শ প্রয়োজন।',
      ...
      vault_balance_label: 'ভল্ট ব্যালেন্স',
      ...
      vault_deposit_sub: 'আপনার দৈনন্দিন ব্যালেন্স থেকে তহবিল ভল্টে সরান। কোনো কী লাগবে না।',
      ...
      vault_enroll_phase_sealing: 'ভল্ট সিল করা হচ্ছে…',
      ...
      vault_backup_title: 'আপনার রিকভারি ফ্রেজ',
      vault_backup_warning: 'এই 24টি শব্দ লিখে রাখুন এবং অফলাইনে সংরক্ষণ করুন। আপনি যদি আপনার YubiKey এবং এই ফ্রেজ দুটোই হারান, তবে ভল্টের তহবিল চিরতরে হারিয়ে যাবে।',
      vault_backup_saved: 'আমি লিখে রেখেছি',
      vault_backup_confirm_title: 'আপনার ফ্রেজ নিশ্চিত করুন',
      vault_backup_confirm_sub: 'আপনি সংরক্ষণ করেছেন তা নিশ্চিত করতে অনুরোধকৃত শব্দগুলো লিখুন।',
      vault_backup_quiz_wrong: 'এটি মেলেনি। আপনার লেখা ফ্রেজ যাচাই করুন।',
      vault_word_n: 'শব্দ {{n}}',
      vault_finish: 'সম্পন্ন করুন',
      ...
      vault_err_seal_corrupt: 'ভল্টের সিল খোলা যায়নি।',
  ...
  ru: {
    translation: {
      ...
      vault_hero_body: 'Переместите средства в хранилище, которое можно открыть только с помощью YubiKey. Пополнения мгновенны; для вывода нужны ключ, PIN-код и касание.',
      ...
      vault_balance_label: 'Баланс хранилища',
      ...
      vault_deposit_sub: 'Переместите средства с повседневного баланса в хранилище. Ключ не нужен.',
      ...
      vault_enroll_phase_sealing: 'Запечатывание хранилища…',
      ...
      vault_backup_title: 'Ваша фраза восстановления',
      vault_backup_warning: 'Запишите эти 24 слова и храните их офлайн. Если вы потеряете YubiKey И эту фразу, средства из хранилища будут утеряны навсегда.',
      vault_backup_saved: 'Я записал',
      vault_backup_confirm_title: 'Подтвердите фразу',
      vault_backup_confirm_sub: 'Введите запрошенные слова, чтобы подтвердить, что вы их сохранили.',
      vault_backup_quiz_wrong: 'Не совпадает. Проверьте записанную фразу.',
      vault_word_n: 'Слово {{n}}',
      vault_finish: 'Завершить',
      ...
      vault_err_seal_corrupt: 'Не удалось открыть печать хранилища.',
  ...
  id: {
    translation: {
      ...
      vault_hero_body: 'Pindahkan dana ke brankas yang hanya bisa dibuka dengan YubiKey Anda. Setoran bersifat instan; penarikan memerlukan kunci, PIN, dan sentuhan.',
      ...
      vault_balance_label: 'Saldo brankas',
      ...
      vault_deposit_sub: 'Pindahkan dana dari saldo harian Anda ke brankas. Tidak perlu kunci.',
      ...
      vault_enroll_phase_sealing: 'Menyegel brankas…',
      ...
      vault_backup_title: 'Frasa pemulihan Anda',
      vault_backup_warning: 'Tuliskan 24 kata ini dan simpan secara offline. Jika Anda kehilangan YubiKey DAN frasa ini, dana brankas hilang selamanya.',
      vault_backup_saved: 'Saya sudah menuliskannya',
      vault_backup_confirm_title: 'Konfirmasi frasa Anda',
      vault_backup_confirm_sub: 'Masukkan kata yang diminta untuk memastikan Anda telah menyimpannya.',
      vault_backup_quiz_wrong: 'Tidak cocok. Periksa frasa yang Anda tulis.',
      vault_word_n: 'Kata {{n}}',
      vault_finish: 'Selesai',
      ...
      vault_err_seal_corrupt: 'Segel brankas tidak dapat dibuka.',
  ...
  ja: {
    translation: {
      ...
      vault_deposit_sub: '普段の残高から保管庫に資金を移動します。キーは不要です。',
      ...
      vault_enroll_phase_sealing: '保管庫を封印しています…',
      ...
      vault_continue: '続ける',
      vault_backup_title: 'リカバリーフレーズ',
      vault_backup_warning: 'この 24 個の単語を書き留め、オフラインで保管してください。YubiKey とこのフレーズの両方を失うと、保管庫の資金は永久に失われます。',
      vault_backup_saved: '書き留めました',
      vault_backup_confirm_title: 'フレーズを確認',
      vault_backup_confirm_sub: '保存したことを確認するため、指定された単語を入力してください。',
      vault_backup_quiz_wrong: '一致しません。書き留めたフレーズを確認してください。',
      vault_word_n: '{{n}} 番目の単語',
      vault_finish: '完了',
      ...
      vault_err_seal_corrupt: '保管庫の封印を開けませんでした。',
  ...
  pl: {
    translation: {
      ...
      vault_hero_body: 'Przenieś środki do sejfu, który można otworzyć tylko za pomocą YubiKey. Wpłaty są natychmiastowe; wypłaty wymagają klucza, PIN-u i dotknięcia.',
      ...
      vault_balance_label: 'Saldo sejfu',
      ...
      vault_deposit_sub: 'Przenieś środki z codziennego salda do sejfu. Klucz nie jest potrzebny.',
      ...
      vault_enroll_phase_sealing: 'Pieczętowanie sejfu…',
      ...
      vault_backup_title: 'Twoja fraza odzyskiwania',
      vault_backup_warning: 'Zapisz te 24 słowa i przechowuj je offline. Jeśli stracisz YubiKey ORAZ tę frazę, środki z sejfu przepadną na zawsze.',
      vault_backup_saved: 'Zapisałem',
      vault_backup_confirm_title: 'Potwierdź frazę',
      vault_backup_confirm_sub: 'Wpisz żądane słowa, aby potwierdzić, że je zapisałeś.',
      vault_backup_quiz_wrong: 'Nie pasuje. Sprawdź zapisaną frazę.',
      vault_word_n: 'Słowo {{n}}',
      vault_finish: 'Zakończ',
      ...
      vault_err_seal_corrupt: 'Nie udało się otworzyć pieczęci sejfu.',
