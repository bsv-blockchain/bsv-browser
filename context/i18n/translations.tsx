...
const resources = {
  en: {
    translation: {
      ...
      local_payments_subtitle: 'Send or receive BSV payments to a nearby device using Bluetooth.',
      ...
      advertising_status: 'Your device is visible to nearby senders.',
      searching_receiver: 'Searching for Receiver',
      scanning_status: 'Looking for a nearby device requesting payment...',
      connecting_peer: 'Connecting',
      ...
      try_again: 'Try Again',
      accept_to_wallet: 'Accept to Wallet',
      payment_auto_internalized: 'Added to wallet automatically',
  ...
  zh: {
    translation: {
      ...
      delete_wallet_warning_body: '这将永久从此设备删除您的钱包密钥。如果您没有备份助记词或打印恢复份额，您将永远无法访问您的钱包。',
      ...
      local_payments: '本地支付',
      local_payments_subtitle: '通过蓝牙向附近设备发送或接收BSV支付。',
      request_payment: '请求支付',
      checking_bluetooth: '检查蓝牙',
      bluetooth_unavailable: '蓝牙不可用',
      waiting_for_sender: '等待发送者',
      advertising_status: '您的设备对附近的发送者可见。',
      searching_receiver: '搜索接收者',
      scanning_status: '正在搜索附近请求支付的设备...',
      connecting_peer: '正在连接',
      building_transaction: '构建交易',
      connected: '已连接',
      sending_payment: '发送支付',
      receiving_payment: '接收支付',
      payment_sent: '支付已发送',
      payment_received: '支付已收到',
      transfer_failed: '传输失败',
      try_again: '重试',
      accept_to_wallet: '接受到钱包',
      payment_auto_internalized: '已自动添加到钱包',
  ...
  hi: {
    translation: {
      ...
      camera_denied_description: 'कैमरा एक्सेस अस्वीकार कर दी गई। इस सुविधा का उपयोग करने के लिए सेटिंग्स में इसे सक्षम करें।',
      ...
      delete_wallet_warning_body: 'यह इस डिवाइस से आपकी वॉलेट कुंजियाँ स्थायी रूप से हटा देगा। यदि आपने अपना रिकवरी फ्रेज़ बैकअप नहीं किया है या रिकवरी शेयर प्रिंट नहीं किए हैं, तो आप अपने वॉलेट तक हमेशा के लिए पहुँच खो देंगे।',
      ...
      local_payments: 'स्थानीय भुगतान',
      local_payments_subtitle: 'ब्लूटूथ का उपयोग करके पास के डिवाइस को BSV भुगतान भेजें या प्राप्त करें।',
      request_payment: 'भुगतान अनुरोध',
      checking_bluetooth: 'ब्लूटूथ जाँच',
      bluetooth_unavailable: 'ब्लूटूथ अनुपलब्ध',
      waiting_for_sender: 'भेजने वाले की प्रतीक्षा',
      advertising_status: 'आपका डिवाइस पास के भेजने वालों को दिखाई दे रहा है।',
      searching_receiver: 'प्राप्तकर्ता खोज रहे हैं',
      scanning_status: 'भुगतान अनुरोध करने वाले पास के डिवाइस की खोज...',
      connecting_peer: 'कनेक्ट हो रहा है',
      building_transaction: 'लेनदेन बना रहे हैं',
      connected: 'कनेक्टेड',
      sending_payment: 'भुगतान भेज रहे हैं',
      receiving_payment: 'भुगतान प्राप्त हो रहा है',
      payment_sent: 'भुगतान भेजा गया',
      payment_received: 'भुगतान प्राप्त हुआ',
      transfer_failed: 'स्थानांतरण विफल',
      try_again: 'पुनः प्रयास करें',
      accept_to_wallet: 'वॉलेट में स्वीकार करें',
      payment_auto_internalized: 'स्वचालित रूप से वॉलेट में जोड़ा गया',
  ...
  es: {
    translation: {
      ...
      delete_wallet_warning_body: 'Esto eliminará permanentemente las claves de tu billetera de este dispositivo. Si no has guardado tu frase de recuperación ni impreso las partes de recuperación, perderás el acceso a tu billetera para siempre.',
      ...
      local_payments: 'Pagos Locales',
      local_payments_subtitle: 'Envía o recibe pagos BSV a un dispositivo cercano usando Bluetooth.',
      request_payment: 'Solicitar Pago',
      checking_bluetooth: 'Verificando Bluetooth',
      bluetooth_unavailable: 'Bluetooth no disponible',
      waiting_for_sender: 'Esperando al remitente',
      advertising_status: 'Tu dispositivo es visible para remitentes cercanos.',
      searching_receiver: 'Buscando receptor',
      scanning_status: 'Buscando un dispositivo cercano que solicite pago...',
      connecting_peer: 'Conectando',
      building_transaction: 'Construyendo transacción',
      connected: 'Conectado',
      sending_payment: 'Enviando pago',
      receiving_payment: 'Recibiendo pago',
      payment_sent: 'Pago enviado',
      payment_received: 'Pago recibido',
      transfer_failed: 'Transferencia fallida',
      try_again: 'Reintentar',
      accept_to_wallet: 'Aceptar en billetera',
      payment_auto_internalized: 'Agregado automáticamente a la billetera',
  ...
  fr: {
    translation: {
      ...
      camera_denied_description: "L'accès à la caméra a été refusé. Vous pouvez l'activer dans les Réglages pour utiliser cette fonctionnalité.",
      ...
      delete_wallet_warning_body: 'Cela supprimera définitivement les clés de votre portefeuille de cet appareil. Si vous n\'avez pas sauvegardé votre phrase de récupération ou imprimé les parts de récupération, vous perdrez l\'accès à votre portefeuille pour toujours.',
      ...
      local_payments: 'Paiements Locaux',
      local_payments_subtitle: 'Envoyez ou recevez des paiements BSV vers un appareil proche via Bluetooth.',
      request_payment: 'Demander un paiement',
      checking_bluetooth: 'Vérification Bluetooth',
      bluetooth_unavailable: 'Bluetooth indisponible',
      waiting_for_sender: "En attente de l'expéditeur",
      advertising_status: 'Votre appareil est visible par les expéditeurs proches.',
      searching_receiver: 'Recherche du destinataire',
      scanning_status: "Recherche d'un appareil proche demandant un paiement...",
      connecting_peer: 'Connexion',
      building_transaction: 'Construction de la transaction',
      connected: 'Connecté',
      sending_payment: 'Envoi du paiement',
      receiving_payment: 'Réception du paiement',
      payment_sent: 'Paiement envoyé',
      payment_received: 'Paiement reçu',
      transfer_failed: 'Transfert échoué',
      try_again: 'Réessayer',
      accept_to_wallet: 'Accepter dans le portefeuille',
      payment_auto_internalized: 'Ajouté automatiquement au portefeuille',
  ...
  ar: {
    translation: {
      ...
      delete_wallet_warning_body: 'سيؤدي هذا إلى حذف مفاتيح محفظتك بشكل دائم من هذا الجهاز. إذا لم تقم بعمل نسخة احتياطية لعبارة الاسترداد أو طباعة حصص الاسترداد، فستفقد الوصول إلى محفظتك إلى الأبد.',
      ...
      local_payments: 'المدفوعات المحلية',
      local_payments_subtitle: 'أرسل أو استقبل مدفوعات BSV إلى جهاز قريب باستخدام البلوتوث.',
      request_payment: 'طلب دفع',
      checking_bluetooth: 'فحص البلوتوث',
      bluetooth_unavailable: 'البلوتوث غير متاح',
      waiting_for_sender: 'في انتظار المرسل',
      advertising_status: 'جهازك مرئي للمرسلين القريبين.',
      searching_receiver: 'البحث عن المستقبل',
      scanning_status: 'البحث عن جهاز قريب يطلب الدفع...',
      connecting_peer: 'جاري الاتصال',
      building_transaction: 'بناء المعاملة',
      connected: 'متصل',
      sending_payment: 'إرسال الدفع',
      receiving_payment: 'استقبال الدفع',
      payment_sent: 'تم إرسال الدفع',
      payment_received: 'تم استقبال الدفع',
      transfer_failed: 'فشل النقل',
      try_again: 'حاول مرة أخرى',
      accept_to_wallet: 'قبول في المحفظة',
      payment_auto_internalized: 'تمت الإضافة تلقائيًا إلى المحفظة',
  ...
  pt: {
    translation: {
      ...
      go_back: 'Voltar',
      continue_action: 'Continuar',
      camera_denied_description: 'O acesso à câmera foi negado. Você pode habilitá-lo em Ajustes para usar este recurso.',
      ...
      delete_wallet_warning_body: 'Isso excluirá permanentemente as chaves da sua carteira deste dispositivo. Se você não fez backup da sua frase de recuperação ou imprimiu as partes de recuperação, você perderá o acesso à sua carteira para sempre.',
      ...
      local_payments: 'Pagamentos Locais',
      local_payments_subtitle: 'Envie ou receba pagamentos BSV para um dispositivo próximo usando Bluetooth.',
      request_payment: 'Solicitar Pagamento',
      checking_bluetooth: 'Verificando Bluetooth',
      bluetooth_unavailable: 'Bluetooth indisponível',
      waiting_for_sender: 'Aguardando remetente',
      advertising_status: 'Seu dispositivo está visível para remetentes próximos.',
      searching_receiver: 'Procurando receptor',
      scanning_status: 'Procurando um dispositivo próximo solicitando pagamento...',
      connecting_peer: 'Conectando',
      building_transaction: 'Construindo transação',
      connected: 'Conectado',
      sending_payment: 'Enviando pagamento',
      receiving_payment: 'Recebendo pagamento',
      payment_sent: 'Pagamento enviado',
      payment_received: 'Pagamento recebido',
      transfer_failed: 'Transferência falhou',
      try_again: 'Tentar novamente',
      accept_to_wallet: 'Aceitar na carteira',
      payment_auto_internalized: 'Adicionado automaticamente à carteira',
  ...
  bn: {
    translation: {
      ...
      camera_denied_description: 'ক্যামেরা অ্যাক্সেস প্রত্যাখ্যান করা হয়েছে। এই বৈশিষ্ট্যটি ব্যবহার করতে সেটিংসে এটি সক্ষম করুন।',
      ...
      delete_wallet_warning_body: 'এটি এই ডিভাইস থেকে আপনার ওয়ালেট কী স্থায়ীভাবে মুছে ফেলবে। যদি আপনি আপনার রিকভারি ফ্রেজ ব্যাকআপ না করেন বা রিকভারি শেয়ার প্রিন্ট না করেন, তাহলে আপনি চিরতরে আপনার ওয়ালেটে অ্যাক্সেস হারাবেন।',
      ...
      local_payments: 'স্থানীয় পেমেন্ট',
      local_payments_subtitle: 'ব্লুটুথ ব্যবহার করে কাছের ডিভাইসে BSV পেমেন্ট পাঠান বা গ্রহণ করুন।',
      request_payment: 'পেমেন্ট অনুরোধ',
      checking_bluetooth: 'ব্লুটুথ পরীক্ষা',
      bluetooth_unavailable: 'ব্লুটুথ অনুপলব্ধ',
      waiting_for_sender: 'প্রেরকের অপেক্ষায়',
      advertising_status: 'আপনার ডিভাইস কাছের প্রেরকদের কাছে দৃশ্যমান।',
      searching_receiver: 'গ্রাহক খুঁজছে',
      scanning_status: 'পেমেন্ট অনুরোধকারী কাছের ডিভাইস খুঁজছে...',
      connecting_peer: 'সংযোগ হচ্ছে',
      building_transaction: 'লেনদেন তৈরি হচ্ছে',
      connected: 'সংযুক্ত',
      sending_payment: 'পেমেন্ট পাঠানো হচ্ছে',
      receiving_payment: 'পেমেন্ট গ্রহণ হচ্ছে',
      payment_sent: 'পেমেন্ট পাঠানো হয়েছে',
      payment_received: 'পেমেন্ট গ্রহণ হয়েছে',
      transfer_failed: 'স্থানান্তর ব্যর্থ',
      try_again: 'আবার চেষ্টা করুন',
      accept_to_wallet: 'ওয়ালেটে গ্রহণ করুন',
      payment_auto_internalized: 'স্বয়ংক্রিয়ভাবে ওয়ালেটে যোগ করা হয়েছে',
  ...
  ru: {
    translation: {
      ...
      camera_denied_description: 'Доступ к камере был отклонён. Вы можете включить его в Настройках, чтобы использовать эту функцию.',
      ...
      delete_wallet_warning_body: 'Это безвозвратно удалит ключи вашего кошелька с этого устройства. Если вы не создали резервную копию фразы восстановления или не распечатали доли восстановления, вы навсегда потеряете доступ к кошельку.',
      ...
      local_payments: 'Локальные платежи',
      local_payments_subtitle: 'Отправляйте или получайте BSV-платежи на ближайшее устройство через Bluetooth.',
      request_payment: 'Запросить платёж',
      checking_bluetooth: 'Проверка Bluetooth',
      bluetooth_unavailable: 'Bluetooth недоступен',
      waiting_for_sender: 'Ожидание отправителя',
      advertising_status: 'Ваше устройство видно ближайшим отправителям.',
      searching_receiver: 'Поиск получателя',
      scanning_status: 'Поиск ближайшего устройства, запрашивающего платёж...',
      connecting_peer: 'Подключение',
      building_transaction: 'Создание транзакции',
      connected: 'Подключено',
      sending_payment: 'Отправка платежа',
      receiving_payment: 'Получение платежа',
      payment_sent: 'Платёж отправлен',
      payment_received: 'Платёж получен',
      transfer_failed: 'Передача не удалась',
      try_again: 'Повторить',
      accept_to_wallet: 'Принять в кошелёк',
      payment_auto_internalized: 'Автоматически добавлено в кошелёк',
  ...
  id: {
    translation: {
      ...
      camera_denied_description: 'Akses kamera ditolak. Anda dapat mengaktifkannya di Pengaturan untuk menggunakan fitur ini.',
      ...
      delete_wallet_warning_body: 'Ini akan menghapus kunci dompet Anda secara permanen dari perangkat ini. Jika Anda belum mencadangkan frasa pemulihan atau mencetak bagian pemulihan, Anda akan kehilangan akses ke dompet Anda selamanya.',
      ...
      local_payments: 'Pembayaran Lokal',
      local_payments_subtitle: 'Kirim atau terima pembayaran BSV ke perangkat terdekat menggunakan Bluetooth.',
      request_payment: 'Minta Pembayaran',
      checking_bluetooth: 'Memeriksa Bluetooth',
      bluetooth_unavailable: 'Bluetooth tidak tersedia',
      waiting_for_sender: 'Menunggu pengirim',
      advertising_status: 'Perangkat Anda terlihat oleh pengirim terdekat.',
      searching_receiver: 'Mencari penerima',
      scanning_status: 'Mencari perangkat terdekat yang meminta pembayaran...',
      connecting_peer: 'Menghubungkan',
      building_transaction: 'Membangun transaksi',
      connected: 'Terhubung',
      sending_payment: 'Mengirim pembayaran',
      receiving_payment: 'Menerima pembayaran',
      payment_sent: 'Pembayaran terkirim',
      payment_received: 'Pembayaran diterima',
      transfer_failed: 'Transfer gagal',
      try_again: 'Coba lagi',
      accept_to_wallet: 'Terima ke dompet',
      payment_auto_internalized: 'Otomatis ditambahkan ke dompet',
