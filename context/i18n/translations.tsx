...
const resources = {
  ...
  zh: {
    translation: {
      ...
      pay_cell_handle_pay: '使用此应用的人',
      pay_cell_handle_pay_sub: '选择或搜索身份',
      pay_cell_address_pay: '传统钱包',
      pay_cell_address_pay_sub: '粘贴或扫描地址',
      pay_cell_nearby_get: '附近的人',
      pay_cell_nearby_get_sub: '出示您的收款二维码',
      pay_cell_handle_get: '使用此应用的人',
      pay_cell_handle_get_sub: '分享您的身份',
      pay_cell_address_get: '传统钱包',
  ...
  hi: {
    translation: {
      ...
      pay_cell_handle_pay: 'इस ऐप का उपयोग करने वाला कोई व्यक्ति',
      pay_cell_handle_pay_sub: 'पहचान चुनें या खोजें',
      pay_cell_address_pay: 'पारंपरिक वॉलेट',
      ...
      pay_cell_handle_get: 'इस ऐप का उपयोग करने वाला कोई व्यक्ति',
      pay_cell_handle_get_sub: 'अपनी पहचान साझा करें',
      pay_cell_address_get: 'पारंपरिक वॉलेट',
  ...
  es: {
    translation: {
      ...
      pay_cell_handle_pay: 'Alguien con esta aplicación',
      pay_cell_handle_pay_sub: 'Elige o busca una identidad',
      pay_cell_address_pay: 'Una billetera convencional',
      ...
      pay_cell_handle_get: 'Alguien con esta aplicación',
      pay_cell_handle_get_sub: 'Comparte tu identidad',
      pay_cell_address_get: 'Una billetera convencional',
  ...
  fr: {
    translation: {
      ...
      pay_cell_handle_pay: 'Quelqu’un qui a cette application',
      pay_cell_handle_pay_sub: 'Choisissez ou recherchez une identité',
      pay_cell_address_pay: 'Un portefeuille classique',
      ...
      pay_cell_handle_get: 'Quelqu’un qui a cette application',
      pay_cell_handle_get_sub: 'Partagez votre identité',
      pay_cell_address_get: 'Un portefeuille classique',
  ...
  ar: {
    translation: {
      ...
      pay_cell_handle_pay: 'شخص لديه هذا التطبيق',
      pay_cell_handle_pay_sub: 'اختر هوية أو ابحث عنها',
      pay_cell_address_pay: 'محفظة تقليدية',
      ...
      pay_cell_handle_get: 'شخص لديه هذا التطبيق',
      pay_cell_handle_get_sub: 'شارك هويتك',
      pay_cell_address_get: 'محفظة تقليدية',
  ...
  pt: {
    translation: {
      ...
      pay_cell_handle_pay: 'Alguém com este aplicativo',
      pay_cell_handle_pay_sub: 'Escolha ou busque uma identidade',
      pay_cell_address_pay: 'Uma carteira convencional',
      ...
      pay_cell_handle_get: 'Alguém com este aplicativo',
      pay_cell_handle_get_sub: 'Compartilhe sua identidade',
      pay_cell_address_get: 'Uma carteira convencional',
  ...
  bn: {
    translation: {
      ...
      pay_cell_handle_pay: 'এই অ্যাপ ব্যবহার করেন এমন কেউ',
      pay_cell_handle_pay_sub: 'একটি পরিচয় বেছে নিন বা খুঁজুন',
      pay_cell_address_pay: 'একটি সাধারণ ওয়ালেট',
      ...
      pay_cell_handle_get: 'এই অ্যাপ ব্যবহার করেন এমন কেউ',
      pay_cell_handle_get_sub: 'আপনার পরিচয় শেয়ার করুন',
      pay_cell_address_get: 'একটি সাধারণ ওয়ালেট',
  ...
  ru: {
    translation: {
      ...
      pay_cell_handle_pay: 'Кто-то с этим приложением',
      pay_cell_handle_pay_sub: 'Выберите или найдите пользователя',
      pay_cell_address_pay: 'Обычный кошелёк',
      ...
      pay_cell_handle_get: 'Кто-то с этим приложением',
      pay_cell_handle_get_sub: 'Поделитесь своим идентификатором',
      pay_cell_address_get: 'Обычный кошелёк',
  ...
  id: {
    translation: {
      ...
      pay_cell_handle_pay: 'Seseorang dengan aplikasi ini',
      pay_cell_handle_pay_sub: 'Pilih atau cari identitas',
      pay_cell_address_pay: 'Dompet biasa',
      ...
      pay_cell_handle_get: 'Seseorang dengan aplikasi ini',
      pay_cell_handle_get_sub: 'Bagikan identitas Anda',
      pay_cell_address_get: 'Dompet biasa',
  ...
  ja: {
    translation: {
      ...
      pay_cell_handle_pay: 'このアプリを使っている人',
      pay_cell_handle_pay_sub: 'アイデンティティを選択または検索',
      pay_cell_address_pay: '一般的なウォレット',
      pay_cell_address_pay_sub: 'アドレスを貼り付けるかスキャン',
      pay_cell_nearby_get: '近くにいる人',
      pay_cell_nearby_get_sub: '自分の支払いコードを見せる',
      pay_cell_handle_get: 'このアプリを使っている人',
      pay_cell_handle_get_sub: '自分のアイデンティティを共有',
      pay_cell_address_get: '一般的なウォレット',
  ...
  pl: {
    translation: {
      ...
      pay_cell_handle_pay: 'Ktoś z tą aplikacją',
      pay_cell_handle_pay_sub: 'Wybierz lub znajdź tożsamość',
      pay_cell_address_pay: 'Zwykły portfel',
      ...
      pay_cell_handle_get: 'Ktoś z tą aplikacją',
      pay_cell_handle_get_sub: 'Udostępnij swoją tożsamość',
      pay_cell_address_get: 'Zwykły portfel',
