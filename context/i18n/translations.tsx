...
const resources = {
  ...
  ja: {
    translation: {
      ...
      go_back: '戻る',
      continue_action: '続行',
      camera_denied_description: 'カメラへのアクセスが拒否されました。この機能を使用するには、設定からカメラを有効にしてください。',
      open_settings: '設定を開く',
      copied: 'コピーしました',
      copy: 'コピー',
      ...
      incoming_payments: '受信中の支払い',
      no_pending_payments: '保留中の支払いはありません',
      accept_all: 'すべて承認',
      payment_note_placeholder: 'メモを追加（例：「割り勘」）',
      ...
      // Local Payments (BLE) screen
      local_payments: 'ローカル決済',
      local_payments_subtitle: 'Bluetoothを使って近くのデバイスにBSVを送受信します。',
      request_payment: '支払いをリクエスト',
      checking_bluetooth: 'Bluetoothを確認中',
      bluetooth_unavailable: 'Bluetoothが利用できません',
      waiting_for_sender: '送信者を待っています',
      advertising_status: 'あなたのデバイスは近くの送信者に表示されています。',
      searching_receiver: '受信者を検索中',
      scanning_status: '支払いをリクエストしている近くのデバイスを探しています...',
      connecting_peer: '接続中',
      building_transaction: 'トランザクションを作成中',
      connected: '接続済み',
      sending_payment: '送金中',
      receiving_payment: '受取中',
      payment_sent: '送金完了',
      payment_received: '受取完了',
      transfer_failed: '送金に失敗しました',
      try_again: 'もう一度試す',
      accept_to_wallet: 'ウォレットに追加',
      payment_auto_internalized: 'ウォレットに自動追加されました',
      ...
      legacy_info:
        '外部ウォレットとのアドレスベースのBSV送受信。プライバシー保護のため、毎日新しいアドレスが生成されます。',
      ...
      scan_shares_camera_description: '印刷されたバックアップシェアのQRコードをスキャンするには、カメラへのアクセスが必要です。',
  ...
  pl: {
    translation: {
      ...
      camera_denied_description: 'Dostęp do kamery został zablokowany. Możesz go włączyć w Ustawieniach, aby korzystać z tej funkcji.',
      ...
      incoming_payments: 'Płatności przychodzące',
      no_pending_payments: 'Brak oczekujących płatności',
      accept_all: 'Akceptuj wszystkie',
      payment_note_placeholder: 'Dodaj notatkę (np. „Podział rachunku")',
      ...
      // Local Payments (BLE) screen
      local_payments: 'Płatności lokalne',
      local_payments_subtitle: 'Wysyłaj lub odbieraj BSV na pobliskie urządzenie przez Bluetooth.',
      request_payment: 'Zażądaj płatności',
      checking_bluetooth: 'Sprawdzanie Bluetooth',
      bluetooth_unavailable: 'Bluetooth niedostępny',
      waiting_for_sender: 'Oczekiwanie na nadawcę',
      advertising_status: 'Twoje urządzenie jest widoczne dla pobliskich nadawców.',
      searching_receiver: 'Szukanie odbiorcy',
      scanning_status: 'Szukam pobliskiego urządzenia żądającego płatności...',
      connecting_peer: 'Łączenie',
      building_transaction: 'Tworzenie transakcji',
      connected: 'Połączono',
      sending_payment: 'Wysyłanie płatności',
      receiving_payment: 'Odbieranie płatności',
      payment_sent: 'Płatność wysłana',
      payment_received: 'Płatność odebrana',
      transfer_failed: 'Transfer nie powiódł się',
      try_again: 'Spróbuj ponownie',
      accept_to_wallet: 'Dodaj do portfela',
      payment_auto_internalized: 'Automatycznie dodano do portfela',
      ...
      order_certifiers_hint: 'Uporządkuj certyfikatorów według priorytetu. Aplikacje będą wyświetlać wyżej ocenionych certyfikatorów jako pierwsze.',
      ...
      legacy_info:
        'Płatności BSV oparte na adresach do i z zewnętrznych portfeli. Codziennie generowany jest nowy adres dla zachowania prywatności.',
      ...
      scan_shares_camera_description: 'Dostęp do kamery jest wymagany do skanowania kodów QR wydrukowanych udziałów kopii zapasowej.',
